...
if ($_SESSION['level'] == 'admin') {
    ...
    $id = intval($_GET['id']);
    $query = mysqli_query($conn, "SELECT * from tbl_jeniskendaraan where id_kendaraan='$id'");
    ...
    if (isset($_POST["submit"])) {
        ...
        <script>
            ...
            document.location.href = 'kendaraan-edit?id=$id';
        </script>";
        }
    }
                    ...
                    <div class="section__content section__content--p30">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">Form Manage Jenis Kendaraan
                                        </div>
                                        <div class="card-body card-block">
                                            <div class="card-title">
                                                <h3 class="text-center title-2">Edit Jenis Kendaraan</h3>
                                            </div>
                                            <hr>
                                            <?php while ($row = mysqli_fetch_array($query)) { ?>
                                                <form method="post" class="form-horizontal">
                                                    <input type="hidden" name="id" value="<?= htmlentities($row['id_kendaraan']); ?>">
                                                    <div class="row form-group">
                                                        <div class="col col-md-3">
                                                            <label for="text-input" class=" form-control-label">Jenis Kendaraan</label>
                                                        </div>
                                                        <div class="col-12 col-md-9">
                                                            <input type="text" id="text-input" name="jeniskendaraan" placeholder="Jenis Kendaraan" class="form-control" value="<?= htmlentities($row['jeniskendaraan']); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col col-md-3">
                                                    ...
                                                    <div class="row form-actions form-group mt-4">
                                                        ...
                                                        <div class="col-lg-4 col-md-12 mt-2">
                                                            <a href="kendaraan-manage" style="width: 100%;">
